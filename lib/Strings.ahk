...
/**
 * Convert a ComObjArray to a string.
 * @param {ComObjArray} comObjArray 
 * @returns {String} 
 */
ComObjArrayToString(comObjArray) {
	s := ""
	; Loop comObjArray.MaxIndex() + 1
	; 	s .= comObjArray[A_Index-1]
    Loop comObjArray.MaxIndex() + 1
		s .= Chr(comObjArray[A_Index-1])
	return s
}
